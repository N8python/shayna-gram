canvas = document.getElementById('codyGram');
...
ctx.fillText("Happy Birthday, Shayna! - The Lahey Bunch", width / 2, height / 2 - 100);
...
var happyBirthday = new sound("Sr. Wooly - Billy y Las Botas (English Subtitles).mp3")
...
function animation() {
  ...
  if (firstFrame < 1401) {
    ...
    ctx.fillStyle = "Red";
    ctx.fillText("Shayna", 20 + firstFrame, 100);
    ctx.fillStyle = "Orange";
    ctx.fillText("Shayna", 1200 - firstFrame, 200);
    ctx.fillStyle = "Green";
    ctx.fillText("Shayna", 20 + firstFrame, 300);
    ctx.fillStyle = "Blue";
    ctx.fillText("Shayna", 1200 - firstFrame, 400);
